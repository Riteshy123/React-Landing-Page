...
export default function LearnMII() {
  return (
    <div>
            <div className="flex md:flex-col justify-between items-center pt-[3px] gap-5 px-[3px]">
                ...
                <div>
                  <div className="h-[298px] relative">
                    <div className="flex flex-col items-end w-[67%] right-0 top-0 m-auto absolute">
                      <Img src="images/img_padlock.png" alt="padlock_one" className="h-[71px] mr-[3px] z-[1]" />
                      <div className="flex self-stretch justify-end items-center mt-[-39px]">
                        <div className="h-[211px] flex-1 relative">
                          ...
                          <div className="justify-center h-[211px] w-full left-0 bottom-0 right-0 top-0 m-auto absolute">
                            <Img
                              src="images/img_vector_blue_gray_700.png"
                              alt="vector_three"
                              ...
                              <div className="flex flex-col justify-center w-max h-max left-0 bottom-0 right-0 top-0 m-auto absolute">
                                <div className="flex flex-col w-[23%] md:w-full ml-8">
                                  <div className="flex flex-col">
                                    <Img
                                      src="images/img_vector_green_500.png"
                                      alt="vector_seven"
                                      className="h-[10px]"
                                    />
                                    <Img
                                ...
                                <div className="h-[12px] mt-1 relative">
                                  <Img
                                    src="images/img_vector_gray_300_12x74.png"
                                    alt="vector"
                                    className="justify-center h-[12px] left-0 bottom-0 right-0 top-0 m-auto absolute"
                                  />
                                ...
                                <div className="h-[12px] mt-1 relative">
                                  <Img
                                    src="images/img_vector_12x74.png"
                                    alt="vector"
                                    className="justify-center h-[12px] left-0 bottom-0 right-0 top-0 m-auto absolute"
                                  />
                                  <div className="flex flex-col w-[58%] bottom-[31%] left-[7%] m-auto absolute">
                                    <div className="flex justify-center items-center">
                                      <Img
                                        src="images/img_vector_green_500_2x2.png"
                                        alt="vector"
                                        className="self-start h-[2px] w-[2px]"
                                      />
                                      <Img
                                        src="images/img_vector_green_500_3x2.png"
                                        alt="vector"
                                    ...
                                    <Img src="images/img_group.png" alt="image_one" className="h-[3px] mt-[-3px]" />
                                  </div>
                                </div>
                                <div className="h-[16px] mt-[21px] ml-[7px] relative">
                                  <Img
                                    src="images/img_vector_green_500_16x55.png"
                                    alt="vector"
                        ...
                        <Img src="images/img_vector_green_500_78x59.png" alt="vector" className="self-end h-[78px]" />
                      </div>
                    </div>
                    <div className="flex justify-end items-start w-[20%] bottom-[21%] right-[1%] m-auto absolute">
                      <Img
                        src="images/img_vector_blue_gray_900_01_101x43.png"
                        alt="vector_fiftyone"
                      ...
                      <div className="flex flex-col items-start mt-[11px] ml-[-39px] gap-[18px]">
                        <div className="flex self-end justify-end items-center">
                          <Img src="images/img_vector_blue_gray_900_01_23x3.png" alt="vector" className="h-[23px]" />
                          <Img
                            src="images/img_vector_blue_gray_900_01_23x3.png"
                            alt="vector"
                            className="self-end h-[5px]"
                          />
                        </div>
                        <Img src="images/img_vector_blue_gray_900_01.png" alt="vector" className="h-[11px]" />
                      </div>
                    </div>
                    <Img
                  ...
                  <Img
                    src="images/img_vector_blue_gray_900_01_1x223.png"
                    alt="vector"
              ...
              <div className="flex flex-col items-start w-[60%] md:w-full mr-24  gap-[22px]">
                <div className="flex flex-col w-[91%] md:w-full gap-[11px] ">
                  <Heading size="lg" as="h2" className="!text-[25.06px] ml-20">
                    How to design your site footer like we did
                  </Heading>
                  <Text size="s" as="p" className="!text-[9.74px] ml-20">
                ...
                <Button shape="round" className="sm:px-5 font-medium min-w-[105px] ml-20">
                  Learn More
                </Button>
              </div>
